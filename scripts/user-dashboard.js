	...
	function displayRooms(rooms) {
		...
		tbody.innerHTML = rooms
            ...
            <tr>
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-primary" onclick="selectRoom(${
											room.id
										})">
...
function displayReservations(reservations) {
	...
	tbody.innerHTML = reservations
        ...
        <tr>
            ...
            <td><span class="badge bg-${getStatusColor(reservation.status)}">${
				reservation.status
			}</span></td>
            <td class="text-end">
...
// Booking Action functionality moved to dedicated page
