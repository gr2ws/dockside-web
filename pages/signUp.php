...
<body class="px-0 px-md-3 flex-col-center">
	...
	<div id="signup-page" class="px-0 px-md-3 flex-col-center">
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			if ((isset($_POST['fname'])) && (isset($_POST['lname'])) && (isset($_POST['address'])) && (isset($_POST['phone']))
				...
				if ($doesExist['instanceCount'] != 0) {
					...
					echo 	'<div class="alert alert-danger d-flex align-items-center mt-4" role="alert">
					...
					if ($conn->query($SQLcommand) === TRUE) {
						...
						unset($_POST['phone']);
						unset($_POST['birth']);
						echo 	'<div class="alert alert-success d-flex align-items-center mt-4" role="alert">
		...
		?>
		<div id="content" class="row w-75 py-4 pt-2">
			<section id="side-thumbnail" class="d-none d-md-block col-md-5"></section>
