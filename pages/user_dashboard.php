                                        ...
                                        <?php foreach ($userBookings as $booking): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php //echo getStatusColor($booking['status']); 
                                                    ?>
                            ...
                            <form id="profileForm" class="mt-4">
                                <div class="mb-4">
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        <img src="<?php echo $userData['profile_photo'] ?? 'images/default-avatar.png'; ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="address" rows="3"><?php echo $userData['address'] ?? ''; ?></textarea>
                                </div>
